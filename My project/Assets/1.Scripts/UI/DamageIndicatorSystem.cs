...
public class DamageIndicatorSystem : MonoBehaviour
{
    ...
    public static Func<Transform, bool> CheckIfObjecttInSight = null;
    ...
    {
        Vector3 screenPoint = playerCamera.WorldToViewportPoint(t.position);
