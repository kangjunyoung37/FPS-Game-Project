...
namespace EZCameraShake
{
    ...
    public class CameraShaker : MonoBehaviour
    {
        ...
        private Dictionary<string, CameraShaker> instanceList = new Dictionary<string, CameraShaker>();
        ...
        void Awake()
        {
            ...
            Instance = this;
            character = transform.root.GetComponent<CharacterBehaviour>();
            instanceList.Add(gameObject.name, this);
        }

        void Update()
        {
            if (character.GetPlayerDead())
                return;
        ...
        /// <returns></returns>
        public CameraShaker GetInstance(string name)
        {
            CameraShaker c;
