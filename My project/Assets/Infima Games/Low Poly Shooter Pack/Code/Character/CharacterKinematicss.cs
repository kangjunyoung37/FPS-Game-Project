...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    /// </summary>
    public class CharacterKinematicss : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            alphaLeft = characterAnimator.GetFloat(AHashess.AlphaIKHandLeft);
            //Get Right Constraint Alpha.
            alphaRight = characterAnimator.GetFloat(AHashess.AlphaIKHandRight);
        }
